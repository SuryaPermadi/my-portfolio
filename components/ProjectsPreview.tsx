    ...
    <section className="relative py-32 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6 text-center md:text-left">
          ...
          >
            <h2 className="text-4xl sm:text-6xl font-black mb-4 text-zinc-950">
              Proyek Pilihan
            </h2>
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <Link href="/projects" className="group flex items-center gap-2 text-zinc-950 font-bold hover:text-blue-600 transition-colors text-lg">
              Lihat Semua Proyek
